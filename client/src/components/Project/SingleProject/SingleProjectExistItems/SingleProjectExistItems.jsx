          ...
          <table className={styles.table_items}>
            <thead>
              <tr>
                ...
                <th>
                  <p className={styles.icon_error}></p>
                </th>
              </tr>
            </thead>
            ...
            <tbody>
              <tr>
                <td>
                  <div className={styles.id_field}>#1</div>
                </td>
                <td>
                  <span>Cement</span>
                </td>
                ...
                <td className={styles.subm}>
                  <span className={styles.submited}>Applied</span>
                </td>
              ...
              <tr className={styles.odd}>
                <td>
                  <div className={styles.id_field}>#2</div>
                </td>
                <td>
                  <span>Cement</span>
                </td>
              ...
              <tr>
                <td>
                  <div className={styles.id_field}>#3</div>
                </td>
                <td>
                  <span>Cement</span>
                </td>
              ...
              <tr className={styles.odd}>
                <td>
                  <div className={styles.id_field}>#4</div>
                </td>
                <td>
                  <span>Cement</span>
                </td>
